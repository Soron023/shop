...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-4">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="#!"><img class="card-img-top" src="/img/posts/{{$feature_post->image}}" alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">{{$feature_post->created_at->format('Y-M-d-D')}}</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @if($loop->iteration % 2 == 0)
                                    <div class="card mb-4">
                                        <a href="#!"><img class="card-img-top" width="354px" src="/img/posts/{{$post->image}}" alt="..." /></a>
                                        <div class="card-body">
                                            <div class="small text-muted">{{$post->created_at->format('Y-M-d-D')}}</div>
                                            <h2 class="card-title h4">{{$post->title}}</h2>
                                            <p class="card-text">{{$post->short_desc}}</p>
                                            <a class="btn btn-primary" href="{{url('show/'.$post->id)}}">Read more →</a>
                                        </div>
                                    </div>
                                @else
                                @endif                           
                    ...
                    <nav aria-label="Pagination">
                        <hr class="my-0" />
                        <div class="pagination justify-content-center my-4"> {{$posts->links('pagination::bootstrap-4');}}</div>
                                ...
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        @foreach($categories as $category)
                                            <li><a href="{{url('/frontend/category/'.$category->id)}}">{{$category->name}}</a></li>
                                        @endforeach
                                        <li><a href="#!">HTML</a></li>
        ...
        {{Html::script('js/frontendscripts.js')}}
    </body>
</html>